...
def get_base_extractor_opts(parser):
    ...
    group.add_argument('--base-extractor', default='mobilenetv2', choices=supported_base_models,
                       help='Which CNN model? Default is mobilenetv2')
    group.add_argument('--s', type=float, default=1.0,
                       help='Factor by which channels will be scaled. Default is 1.0 for mobilenetv2')
    group.add_argument('--weights', type=str, default='model/pretrained_cnn_models/mobilenetv2_s_1.0_imagenet_224x224.pth',
