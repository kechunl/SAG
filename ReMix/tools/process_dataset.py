...
def split_camelyon16():
    ...
    os.makedirs('datasets/Camelyon16/processed', exist_ok=True)
    train_list_txt = open('datasets/Camelyon16/processed/train_list.txt', 'w')
    test_list_txt = open('datasets/Camelyon16/processed/test_list.txt', 'w')
    ...
    np.save('datasets/Camelyon16/processed/test_bag_labels.npy', test_labels)
    np.save('datasets/Camelyon16/processed/train_bag_labels.npy', train_labels)
    print('done')
